...
<div id="site_content" class="content researchPage">
   <div id="top_border"></div> 
    <div class="supportedResearch">
       ...
       <ul>
      <li> NSF DMS/<a href="https://www.nsf.gov/funding/pgm_summ.jsp?pims_id=501081">FODAVA</a> Grant  <a href="https://www.nsf.gov/cise/funding/2008_FODAVA_awards.xls"> No. 0808860</a>:
...
<div id="site_content"></div> 
    ...
    <div align="left"><font style="font-family:
        Helvetica,Arial,sans-serif;" color="black" size="4">Geospatial-temporal visualizations</font></div>
   <div style="margin-top: 5px">
    <left> Related publications: <br>
    <ul>
    <li> <b>Tuan Dang</b>, Leland Wilkinson, and Anushka Anand. <i>Stacking Graphic Elements to Avoid Over-Plotting</i>. IEEE Transactions on Visualization AndComputer Graphics 16(6), InfoVis 2010.  <a href="file/Stacking.pdf"> <img src="images/icons2/pdf.png" height="16"></a> <a href="https://www.cs.uic.edu/~tdang/media/Stacking.mp4"> <img src="images/icons2/movie.png" height="16"></a> <a href="BibTeX/Dang2010Stacking.txt"> <img src="images/icons2/bibtex.png" height="16"></a> 
<a href="http://ieeexplore.ieee.org/xpl/login.jsp?tp=&arnumber=5613442" class="button">DOI</a>
  ...
  <div  align="middle" style="margin-top: -20px"> <img src="images/projectFigures/UFO2.png"  width=100%></div>
...
or brightness could reveal the threefold increase in Lyme disease cases centered around New England vs. the Midwest.
  ...
  <div id="site_content"></div> 
   <div id="top_border"></div> 
    ...
    <div align="left"><font style="font-family:
        Helvetica,Arial,sans-serif;" color="black" size="4">Networks and structures</font></div>
  ...
  <left>Visualizing hierarchical structures and prey-predator relationships of mammals (left) and birds (right). Each animal is presented as a green leaf node. Red links are prey-predator relationships between them.</left>
  
  <div  align="middle" style="margin-top: 20px"> <img src="images/projectFigures/HCLdiseases.png"  width=90%></div>
  <left>Visualizing causal relationships of 20 popular diseases (left) from <a href="http://www.reactome.org/">reactome</a> and HIV life cycle (right): Gradient links indicate causalities between biochemical reactions.</left>
  ...
  <div class="content fullPage" style="margin-top: 5px">
    <left> Related publications: <br>
    <ul>
        ...
        <li> <b>Tommy Dang</b>, Anushka Anand, and Leland Wilkinson. <i>TimeSeer: Scagnostics for High-Dimensional Time Series</i>. IEEE Transactions on Visualization and Computer Graphics 19(3), TVCG 2012.  
          <a href="file/Multi-Scagnostics.pdf"> <img src="images/icons2/pdf.png" height="16"></a>  
          <a href="media/TimeSeer.mov"> <img src="images/icons2/movie.png" height="16"></a>
          <a href="BibTeX/Dang2012Timeseer.txt"> <img src="images/icons2/bibtex.png" height="16"></a> 
          <a href="http://ieeexplore.ieee.org/xpl/login.jsp?tp=&arnumber=6200267" class="button">DOI</a>
        </li>
    </ul>
    </left>
   </div>  
